...
dfmm <- nc[complete.cases(nc),!names(nc) %in% nokeep]    #### complete cases!!!
...
```{r}
save(mod_randomforest500, file = "C:/Users/Carey Suehs/Documents/GitHub/Wild_Fires/models/northcarolina_randomforest.rda")
```


```{r}
load("C:/Users/Carey Suehs/Documents/GitHub/Wild_Fires/models/northcarolina_randomforest.rda")
```


```{r}
```{r}
pdf(file = "northcarolina_roc.pdf")
