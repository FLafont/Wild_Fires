...
df_test <- test_nc[,!names(test_nc) %in% nokeep]
...
```{r}
test_nc$pred <- df_test$pred


write.csv(test_nc, "C:/Users/Carey Suehs/Documents/GitHub/Wild_Fires/models/nc_pred.csv")
```


```{r}
pdf("northcarolina_roc_external.pdf")
plot.roc(df_test$Y, 
                  df_test$pred, 
                  main="Confidence intervals", 
                  percent=TRUE, 
