...
```{r}
save(mod_randomforest500, file = "C:/Users/Carey Suehs/Documents/GitHub/Wild_Fires/models/florida_randomforest.rda")
```


```{r}
load("C:/Users/Carey Suehs/Documents/GitHub/Wild_Fires/models/florida_randomforest.rda")
```
